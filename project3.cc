...
main (int argc, char *argv[])
{
    ...
    if( pcap ==true ){
        ...
        phy_0.EnablePcap ("project3", apDevices_0.Get (0));
        phy_1.EnablePcap ("project3", apDevices_1.Get (0));
    }
    
    if( ascii ==true ){
        AsciiTraceHelper ascii;
        pointToPoint.EnableAsciiAll (ascii.CreateFileStream ("project3-0.tr"));
        phy_0.EnableAsciiAll (ascii.CreateFileStream ("project3-1.tr"));
        phy_1.EnableAsciiAll (ascii.CreateFileStream ("project3-2.tr"));
    }
